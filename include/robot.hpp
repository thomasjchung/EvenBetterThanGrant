...
struct robot {
    ...
    static pros::Motor motor_lf, motor_lb, motor_rf, motor_rb, launcher_f, launcher_c, basket, intake, expansion;
    static pros::ADIDigitalOut piston_shooter, piston_back_claw;  //piston_back_lift?
